...
* photographs of gravel and cobbles on beaches [@Roberts:2024] and on fluvial bars (Figure 2);  
* photomicrographs (taken in transmitted light) of thin sections of sandstones (Figure 3) and oolitic limestones;  
* photomicrographs (taken in reflected light) of sand and detrital zircon grains.

![Photo of fluvial gravel (A), output of the \`Segmenteverygrain\` segmentation (B), size distributions of the major and minor grain axes (C), and the area-weighted size distributions (D). Major grain axis lengths are shown in blue, minor grain axis lengths in orange.](joss_paper_fig_2.jpg)
